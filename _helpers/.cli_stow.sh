...
if [[ -z $DOTFILES ]]; then
  printf "Make sure \$DOTFILES is set. "
  printf "Add the following to your .bashrc or .zshrc file and restart your shell:\n\n"
  printf '  export DOTFILES="/path/to/dotfiles/directory"\n'
  return 1
fi
